...
export function ItineraryForm() {
  ...
  const isGenerationDisabled = !isSubscribed && itinerariesGenerated >= FREE_ITINERARY_LIMIT;
  const isGuest = !user;
  ...
  async function onSubmit(values: FormValues) {
    ...
    if (isGenerationDisabled) {
      setError("You have reached your free itinerary generation limit. Please upgrade to continue.");
      return;
    }
    ...
    setError(null);
    try {
        // Increment usage count for free users *before* generation
    ...
    if (isGuest) {
        return (
             <Alert variant="destructive" className="text-center">
                ...
                <AlertDescription>
                   Please create a free account to start planning your trips with Wanderwise AI.
                </AlertDescription>
    ...
    if (isGenerationDisabled) {
        return (
            <Alert variant="destructive" className="text-center">
                ...
                <AlertDescription>
                    You have used your {FREE_ITINERARY_LIMIT} free itinerary generations. Please upgrade for unlimited creations and to save your trips.
                </AlertDescription>
                <Button asChild size="sm" className="mt-4">
    ...
    <div>
       {alertContent ? alertContent : (
        <Card>
            ...
            <Form {...form}>
                ...
                />
                <Button type="submit" disabled={isLoading || isGenerationDisabled} className="w-full">
                    {isLoading ? (
                        <>
      ...
      {user && !isSubscribed && !alertContent && (
        <p className="mt-4 text-center text-sm text-muted-foreground">
            You have used {itinerariesGenerated} of your {FREE_ITINERARY_LIMIT} free generations.
        </p>
      )}
    </div>
  );
